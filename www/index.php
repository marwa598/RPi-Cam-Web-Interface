...
<html>
   <head>
      ...
      <title> Projet fin d'étude réalisé par Marwa & Amira</title>
       <img  src="download2.jpeg" align="left" width="170" height="170"/>
       <img  src="iset2.jpeg" align="right"  width="200" height="200"/>
       <p style="text-align:center;">MINISTERE DE L’ENSEIGNEMENT SUPERIEUR ET DE LA RECHERCHE SCIENTIFIQUE<p>
       <p style="text-align:center;">DIRECTION GÉNÉRALE DES ÉTUDES TECHNOLOGIQUES</p>
       <p style="text-align:center;">Institut Supérieur des Études Technologiques de Djerba</p>
       <p style="text-align:center;">Département Génie Electrique</p>   
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" >
         <div class="container">
          <div class="navbar-header">
               <a class="navbar-brand" href="#"> Projet fin d'étude réalisé par Marwa & Amira< </a>
            </div>
         </div>
      </div>
	  <?php simple_button(); ?>
